...
def _enigma_cmd(params, is_query):
    ...
    if p == "M3" and not isinstance(state.enigma, EnigmaM3):
        state.enigma = EnigmaM3(plugboard=SwappablePlugboard(), rotor1=None, rotor2=None, rotor3=None, reflector=None, etw=EtwPassthrough(), auto_increment_rotors=True)
        return True, None
    if p == "M4" and not isinstance(state.enigma, EnigmaM4):
        state.enigma = EnigmaM4(plugboard=SwappablePlugboard(), rotor1=None, rotor2=None, rotor3=None, rotor4=None, reflector=None, etw=EtwPassthrough(), auto_increment_rotors=True)
        return True, None
    else:
